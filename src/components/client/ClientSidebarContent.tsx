...
import { sidebarItems } from "./ClientSidebarItems";
            ...
            <SidebarMenu>
              {sidebarItems.map((item) => (
                <SidebarMenuItem key={item.title}>
                          ...
                          <a href={item.href} className="flex items-center justify-between w-full">
                            <div className="flex items-center gap-3">
                              ...
                              <span className={cn(
                                ...
                                isCollapsed ? "opacity-0 hidden md:inline-block md:opacity-0" : "opacity-100"
                              )}>
                                {item.title}
                              </span>
                            </div>
                  ...
                  {!isCollapsed && item.subItems && openItems.includes(item.title) && (
                    <SidebarMenuSub>
